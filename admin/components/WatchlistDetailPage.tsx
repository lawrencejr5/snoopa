...
export default function WatchlistDetailPage({
  ...
  const handleDeleteWatchlist = async () => {
    try {
      ...
      alert(
        "Watchlist and associated chats & notifications deleted successfully.",
      );
          ...
          >
            ...
            >
              ...
              >
                ...
                <span
                  style={{ fontStyle: "italic", color: "var(--accent-milk)" }}
                >
                  "{watchlist.condition}"
                </span>
              </div>
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                  ...
                  <span>
                    ...
                    {owner ? (
                      <button
                        onClick={() => router.push(`/customers/${owner._id}`)}
                        style={{
                          background: "none",
                          border: "none",
                ...
                <span>
                  • Created:{" "}
                  {new Date(watchlist._creationTime).toLocaleDateString()}
                </span>
                <span>
                  • Last Checked: {formatTimeAgo(watchlist.last_checked)}
                </span>
              </div>
            </div>
      ...
      <div className="metrics-grid">
        <div className="card">
          ...
          <div className="metric-sub">
            Total user queries & Snoopa investigator responses
          </div>
        </div>
        ...
        <div className="card">
          ...
          <div className="metric-sub">
            {notifications.filter((n: any) => n.read || n.seen).length} Read /
            Seen
          </div>
        </div>
        ...
        <div className="card">
          ...
          <div className="metric-value">
            {monitored_sources.length || watchlist.sources?.length || 0}
          </div>
          <div className="metric-sub">
            {processed_headlines.length} headlines scraped
          </div>
        </div>
      ...
      {activeTab === "logs" && (
        ...
        >
          ...
          <div className="card" style={{ padding: 20 }}>
            ...
            >
              <Activity
                style={{ width: 16, height: 16, color: "var(--accent-green)" }}
              />{" "}
              Execution & Snooper Logs ({logs.length})
            </h4>
          ...
          <div className="card" style={{ padding: 20 }}>
            ...
            >
              <Globe
                style={{ width: 16, height: 16, color: "var(--accent-milk)" }}
              />{" "}
              Monitored Web Sources (
              {monitored_sources.length || watchlist.sources?.length || 0})
            </h4>

            {monitored_sources.length === 0 &&
            (!watchlist.sources || watchlist.sources.length === 0) ? (
              <div
                style={{
                  color: "var(--text-secondary)",
                  fontSize: 13,
              ...
              >
                No explicit sources attached; utilizing standard Tavily google
                search index.
              </div>
            ) : (
              <div
            ...
            >
              ...
              >
                ...
                <span style={{ fontWeight: 600 }}>
                  {(watchlist.search_type || "general").toUpperCase()}
                </span>
              </div>
              <div
                style={{
              ...
              >
                ...
                <span style={{ fontWeight: 600 }}>
                  {(watchlist.time_range || "any_time").toUpperCase()}
                </span>
              </div>
              <div
                style={{
            ...
            {owner ? (
              ...
              >
                ...
                >
                  ...
                  <span
                    className={`badge ${owner.sub_tier === "max" ? "badge-danger" : owner.sub_tier === "pro" ? "badge-green" : "badge-muted"}`}
                  >
                ...
                <div style={{ paddingTop: 8 }}>
                  ...
                  >
                    <User style={{ width: 14, height: 14 }} /> View Full
                    Customer Profile
                  </button>
                </div>
              </div>
